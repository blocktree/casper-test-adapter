...
var (
	...
	dbFileName     = "blockchain-TCSPR.db"
)
...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO TCSPR", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "WAa8gHLJnRa5mCBuSz1CxbtzuJdpUXjQtM")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WAa8gHLJnRa5mCBuSz1CxbtzuJdpUXjQtM"
	account := &openwallet.AssetsAccount{Alias: "mainnetTCSPR", WalletID: walletID, Required: 1, Symbol: "TCSPR", IsTrust: true}
